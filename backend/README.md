...
## Project Structure
    ...
    ├── testapiautoconnect_126445  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_126445`
...
2. Clone this repo and `cd testapiautoconnect_126445`
